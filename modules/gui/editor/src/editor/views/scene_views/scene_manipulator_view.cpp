...
void SceneManipulatorView::RenderConfig() {
    ...
    ImGui::RadioButton("Translate", &e, TRANSLATE_ID);
    ImGui::SameLine();
    ImGui::RadioButton("Rotate", &e, ROTATE_ID);
    ImGui::SameLine();
    ...
    switch (e) {
        case TRANSLATE_ID:
            current_operation_ = SceneManipulatorOperation::TRANSLATE;
            break;
        case ROTATE_ID:current_operation_ = SceneManipulatorOperation::ROTATE;
            break;
        case SCALE_ID:current_operation_ = SceneManipulatorOperation::SCALE;
            break;
    }
}
