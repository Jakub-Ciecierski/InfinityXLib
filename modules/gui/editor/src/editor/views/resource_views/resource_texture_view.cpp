...
ResourceTextureView::ResourceTextureView(): selected_(-1){}

void ResourceTextureView::Render(ResourceFinder &resource_finder) {
...
void ResourceTextureView::RenderGroup(ResourceFinder &resource_finder){
    RenderList(resource_finder);
    RenderSelectedTexture();
}

void ResourceTextureView::RenderList(ResourceFinder &resource_finder){
...
void ResourceTextureView::RenderSelectedTexture(){
