...
void ImGui_ImplGlfwGL3_RenderDrawLists(ImDrawData *draw_data) {
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++) {
        ...
        glBufferData(GL_ARRAY_BUFFER,
                     ...
                     (GLvoid *) cmd_list->VtxBuffer.Data,
                     GL_STREAM_DRAW);

        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, g_ElementsHandle);
        glBufferData(GL_ELEMENT_ARRAY_BUFFER,
                     (GLsizeiptr) cmd_list->IdxBuffer.Size * sizeof(ImDrawIdx),
                     (GLvoid *) cmd_list->IdxBuffer.Data,
                     GL_STREAM_DRAW);
...
void ImGui_ImplGlfwGL3_MouseButtonCallback(GLFWwindow *,
                                           int button,
                                           int action,
                                           int /*mods*/) {
...
void ImGui_ImplGlfwGL3_ScrollCallback(GLFWwindow *,
                                      double /*xoffset*/,
                                      double yoffset) {
    g_MouseWheel +=
...
void ImGui_ImplGlfwGL3_KeyCallback(GLFWwindow *,
                                   int key,
                                   int,
                                   int action,
                                   int mods) {
