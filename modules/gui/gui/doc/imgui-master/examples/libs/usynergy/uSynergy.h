...
**/
typedef uSynergyBool
(*uSynergySendFunc)(uSynergyCookie cookie, const uint8_t *buffer, int length);
...
**/
typedef void
(*uSynergyTraceFunc)(uSynergyCookie cookie, const char *text);
...
**/
typedef void
(*uSynergyScreenActiveCallback)(uSynergyCookie cookie, uSynergyBool active);
...
typedef struct {
    ...
    uSynergyConnectFunc
        m_connectFunc;                                    /* Connect function */
    uSynergySendFunc
        m_sendFunc;                                        /* Send data function */
    uSynergyReceiveFunc
        m_receiveFunc;                                    /* Receive data function */
    uSynergySleepFunc
        m_sleepFunc;                                    /* Thread sleep function */
    uSynergyGetTimeFunc
        m_getTimeFunc;                                    /* Get current time function */
    const char *
        m_clientName;                                    /* Name of Synergy Screen / Client */
    uint16_t
        m_clientWidth;                                    /* Width of screen */
    uint16_t
        m_clientHeight;                                    /* Height of screen */
    ...
    uSynergyMouseCallback
        m_mouseCallback;                                /* Callback for mouse events */
    ...
    uSynergyBool
        m_connected;                                    /* Is our socket connected? */
    uSynergyBool
    ...
    uint32_t
        m_sequenceNumber;                                /* Packet sequence number */
    uint8_t
        m_receiveBuffer[USYNERGY_RECEIVE_BUFFER_SIZE];    /* Receive buffer */
    int
        m_receiveOfs;                                    /* Receive buffer offset */
    uint8_t m_replyBuffer[USYNERGY_REPLY_BUFFER_SIZE];        /* Reply buffer */
    uint8_t *
        m_replyCur;                                        /* Write offset into reply buffer */
    uint16_t
        m_mouseX;                                        /* Mouse X position */
    uint16_t
        m_mouseY;                                        /* Mouse Y position */
    int16_t
        m_mouseWheelX;                                    /* Mouse wheel X position */
    int16_t
        m_mouseWheelY;                                    /* Mouse wheel Y position */
    uSynergyBool
        m_mouseButtonLeft;                                /* Mouse left button */
    uSynergyBool
        m_mouseButtonRight;                                /* Mouse right button */
    uSynergyBool
        m_mouseButtonMiddle;                            /* Mouse middle button */
