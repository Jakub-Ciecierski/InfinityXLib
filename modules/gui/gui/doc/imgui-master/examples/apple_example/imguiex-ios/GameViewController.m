...
- (IBAction)onServernameTapped: (id)sender
{
    ...
    alert.tag =
        SERVERNAME_ALERT_TAG; // cheezy way to tell which alert view we're responding to
    [alert
    show];
}
...
GLKMatrix4 projectionMatrix =
    GLKMatrix4MakePerspective(GLKMathDegreesToRadians(65.0f),
                              aspect,
                              0.1f,
                              100.0f);
...
self.effect.light0.
diffuseColor = GLKVector4Make(_hud.cubeColor2[0],
                              _hud.cubeColor2[1],
                              _hud.cubeColor2[2],
                              1.0f);
