...
void ImGui_ImplDX10_RenderDrawLists(ImDrawData *draw_data) {
    ...
    // Setup orthographic projection matrix into our constant buffer
    {
        ...
        if (g_pVertexConstantBuffer
            ->Map(D3D10_MAP_WRITE_DISCARD, 0, &mapped_resource) != S_OK)
            return;
        VERTEX_CONSTANT_BUFFER
            *constant_buffer = (VERTEX_CONSTANT_BUFFER *) mapped_resource;
        const float L = 0.0f;
        ...
        D3D10_INPUT_ELEMENT_DESC local_layout[] =
            {
                ...
                {"TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0,
                 (size_t)(&((ImDrawVert *) 0)->uv), D3D10_INPUT_PER_VERTEX_DATA,
                 0},
...
bool ImGui_ImplDX10_Init(void *hwnd, ID3D10Device *device) {
    ...
    io.RenderDrawListsFn =
        ImGui_ImplDX10_RenderDrawLists;  // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.
