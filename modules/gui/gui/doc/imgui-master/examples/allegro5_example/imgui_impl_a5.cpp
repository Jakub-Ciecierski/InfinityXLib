...
void ImGui_ImplA5_RenderDrawLists(ImDrawData *draw_data) {
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++) {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
            ...
            if (pcmd->UserCallback) {
                ...
                al_set_clipping_rectangle(pcmd->ClipRect.x,
                                          pcmd->ClipRect.y,
    ...
    al_set_clipping_rectangle(0,
                              0,
                              al_get_display_width(g_Display),
                              al_get_display_height(g_Display));
}
...
bool ImGui_ImplA5_Init(ALLEGRO_DISPLAY *display) {
    ...
    io.RenderDrawListsFn =
        ImGui_ImplA5_RenderDrawLists;        // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.
#ifdef _WIN32
